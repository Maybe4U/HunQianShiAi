 ...
 * 会员中心支付
 */
public class MemberPayActivity extends BasesActivity implements CompoundButton.OnCheckedChangeListener, BaseView<String> {
    @Bind(R.id.cb_zfb)
    CheckBox zfb;
    @Bind(R.id.cb_wx)
    CheckBox wx;
    ...
    public void success(String bean) {
        if (paytype == 1) {//支付宝
            ...
            Runnable payRunnable = new Runnable() {
                ...
                @Override
                public void run() {
                    PayTask alipay = new PayTask(MemberPayActivity.this);
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        UrlContent.IS_MEMBER_KEY = true;
                        Toast.makeText(MemberPayActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
//                        openActivity(NameAuthenticationActivity.class);
                        finish();
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                        Toast.makeText(MemberPayActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
                case SDK_AUTH_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000") && TextUtils.equals(authResult.getResultCode(), "200")) {
                        ...
                        // 其他状态值则为授权失败
                        Toast.makeText(MemberPayActivity.this, "授权失败" + String.format("authCode:%s", authResult.getAuthCode()), Toast.LENGTH_SHORT).show();
