 ...
 * 提交认证申请
 */
public class CertificationPayActivity extends BasesActivity implements CompoundButton.OnCheckedChangeListener, BaseView<String> {
    ...
    protected void initView() {
        ...
        mBeizhu = bundle.getString("beizhu");
...
//                mParams.put("price", 0.01);
                ...
                mParams.put("beizhu", mBeizhu);
                mParams.put("paytype", paytype);
                mPresenter.getData(UrlContent.PAY_URL, mParams, BaseModel.DEFAULT_TYPE);
//                openActivity(NameAuthenticationActivity.class);
                break;
            case R.id.tv_cancel:
                PopupWindowFinish popupWindowFinish = new PopupWindowFinish(this);
                popupWindowFinish.showAtLocation(mCheckWX, Gravity.CENTER, 0, 0);
                break;
        }
    }
    ...
    public void success(String bean) {
        ...
        if (paytype == 1) {//支付宝
            ...
            Runnable payRunnable = new Runnable() {
                ...
                @Override
                public void run() {
                    PayTask alipay = new PayTask(CertificationPayActivity.this);
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(CertificationPayActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        openActivity(NameAuthenticationActivity.class);
                        finish();
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                        Toast.makeText(CertificationPayActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
                case SDK_AUTH_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000") && TextUtils.equals(authResult.getResultCode(), "200")) {
                        ...
                        // 传入，则支付账户为该授权账户
                        Toast.makeText(CertificationPayActivity.this, "授权成功\n" + String.format("authCode:%s", authResult.getAuthCode()), Toast.LENGTH_SHORT)
                                .show();
                    } else {
                        // 其他状态值则为授权失败
                        Toast.makeText(CertificationPayActivity.this, "授权失败" + String.format("authCode:%s", authResult.getAuthCode()), Toast.LENGTH_SHORT).show();
