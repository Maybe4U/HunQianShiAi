...
public class InformationDetailsAdapter extends BaseQuickAdapter<DynamicDetailsBean.Comment, BaseViewHolder> {
    public InformationDetailsAdapter(@Nullable List<DynamicDetailsBean.Comment> data) {
