 ...
 * 充值
 */
public class RechargeActivity extends BasesActivity implements CompoundButton.OnCheckedChangeListener, BaseView<String> {
    @Bind(R.id.check_zfb)
    CheckBox mCheckZFB;
    @Bind(R.id.check_wx)
    CheckBox mCheckWX;
...
//                mParams.put("price", 0.01);
                mParams.put("price", trim);
                mParams.put("type", 4);
                mParams.put("beizhu","充值");
