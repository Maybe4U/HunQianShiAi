 ...
 */
public class UserHobbyInterestAdapter extends BaseQuickAdapter<HobbyInterestBean.Label,BaseViewHolder> {
    private TagFlowLayout mFlowlayout;

    public UserHobbyInterestAdapter(@Nullable List<HobbyInterestBean.Label> data) {
        super(R.layout.user_hobby_interest_item, data);
    }
