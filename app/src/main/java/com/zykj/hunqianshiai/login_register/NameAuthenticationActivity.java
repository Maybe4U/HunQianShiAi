 ...
 * 实名认证
 */
public class NameAuthenticationActivity extends BasesActivity implements BaseView<String> {
    ...
    @OnClick({R.id.tv_submit, R.id.tv_skip, R.id.iv_front, R.id.iv_front2,R.id.tv_text})
    @Override
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.tv_text:
                ...
                bundle.putString("url","http://47.104.91.22/api.php?c=Fell&a=xieyi&id=2");
                bundle.putString("title","为什么上传身份证");
